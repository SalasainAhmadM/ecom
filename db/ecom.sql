...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2022 at 01:01 AM
...
INSERT INTO `accounts` (`user_id`, `name`, `email`, `user_type`, `vcode`, `date_registered`, `password`, `photo`, `address`) VALUES
...
(42, 40, '2022-05-31 15:24:28', '3', ''),
(43, 40, '2022-05-31 15:41:58', '3', ''),
(44, 40, '2022-05-31 15:42:14', '4', 'asdasd'),
(45, 40, '2022-05-31 23:16:59', '4', 'asda');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=468;
