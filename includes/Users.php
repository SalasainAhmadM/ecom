...
class Users  {
   ...
   public function fetchdata($con){
    ...
    public function Adduser($con,$name,$email,$pass,$delivery_address){
      
        date_default_timezone_set('Asia/Manila');
        $datenow = date('Y-m-d H:i:s');
       
        $query = "INSERT INTO `accounts`(`name`, `email`, `user_type`, `date_registered`, `password`, `address`) 
        VALUES ('$name','$email','user','$datenow','$pass','$delivery_address')";
    ...
    public function Updateuser($con,$name,$email,$pass,$delivery_address,$photo,$id){
        ...
        if($photo == ''){
            ...
            `address`='$delivery_address' WHERE user_id = '$id' ";
    mysqli_query($con,$query);  
        }else {
