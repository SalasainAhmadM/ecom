<div class="container">
<h5 style="  font-family: Verdana, sans-serif;">My Orders</h5>
<div class="btn-group" >
...
if($fetchorder){
  ...
  <li class="nav-item">
    <a class="nav-link active text-light bg-info " style="font-size:13px;background-color: gray;" aria-current="page" href="#"><?php echo 'ORDER NO '.$row['tid']?></a>
  </li>
...
<div class="row">
    <div class="col-md-3" style="border-right:1px solid grey">
        <img src="<?php echo $src?>" alt="" style="width:200px;height:auto" class="img-thumbnail form-control">
    </div>
    <div class="col-md-9">
    ...
    <img src="assets/image_assets/empty.jpg" alt="" style="width:400px">
    <br>
    No Orders Yet!
